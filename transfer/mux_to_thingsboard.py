...
class server_put(resource.Resource):
    ...
    async def render_put(self, request):
        ...
        publish_client.publish("v1/devices/me/telemetry", payload)
...
def on_message(client, userdata, msg):
    ...
    publish_client.publish("v1/devices/me/telemetry", msg.payload)
...
publish_client.username_pw_set("iot_g17","12345678")
publish_client.connect("mqtt.thingsboard.cloud", 1883, 60)
